...
namespace Email.Server.Migrations
{
    ...
    [Migration("20251222065148_AddLastSmsStripeReportUtc")]
    partial class AddLastSmsStripeReportUtc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Email.Server.Models.BillingPlans", b =>
                {
                    ...
                    b.Property<int>("MaxSmsPhoneNumbers")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Email.Server.Models.RegionsCatalog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Region = "us-east-1",
                            CreatedAtUtc = new DateTime(2025, 12, 22, 6, 51, 45, 535, DateTimeKind.Utc).AddTicks(1346),
                        ...
                        {
                            Region = "us-west-2",
                            CreatedAtUtc = new DateTime(2025, 12, 22, 6, 51, 45, 535, DateTimeKind.Utc).AddTicks(4202),
                        ...
                        {
                            Region = "eu-west-1",
                            CreatedAtUtc = new DateTime(2025, 12, 22, 6, 51, 45, 535, DateTimeKind.Utc).AddTicks(4206),
                            DefaultForNewTenants = false,
                        ...
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2025, 12, 22, 6, 51, 45, 535, DateTimeKind.Utc).AddTicks(4208),
                            DefaultForNewTenants = false,
            ...
            modelBuilder.Entity("Email.Server.Models.SmsEvents", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SmsMessageId")
                        .HasDatabaseName("IX_SmsEvents_MessageId");

                    b.HasIndex("TenantId", "OccurredAtUtc")
                        .HasDatabaseName("IX_SmsEvents_Tenant_Time");

                    b.ToTable("SmsEvents", (string)null);
                });

            modelBuilder.Entity("Email.Server.Models.SmsMessages", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("AwsMessageId")
                        .HasDatabaseName("IX_SmsMessages_AwsMessageId");
                    ...
                    b.HasIndex("Status", "ScheduledAtUtc")
                        .HasDatabaseName("IX_SmsMessages_Scheduled")
                        .HasFilter("[Status] = 4");

                    b.HasIndex("TenantId", "RequestedAtUtc")
                        .HasDatabaseName("IX_SmsMessages_Tenant_Time");

                    b.ToTable("SmsMessages", (string)null);
                });

            modelBuilder.Entity("Email.Server.Models.SmsPhoneNumbers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("MonthlyFeeCents")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PhoneNumberArn")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.HasIndex("PhoneNumber")
                        .IsUnique()
                        .HasDatabaseName("UQ_SmsPhoneNumbers_Number");

                    b.HasIndex("TenantId", "IsDefault")
                        .HasDatabaseName("IX_SmsPhoneNumbers_TenantDefault");

                    b.ToTable("SmsPhoneNumbers", (string)null);
                });

            modelBuilder.Entity("Email.Server.Models.SmsTemplates", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("TenantId", "Name")
                        .IsUnique()
                        .HasDatabaseName("UQ_SmsTemplates_TenantName");
            ...
            modelBuilder.Entity("Email.Server.Models.Suppressions", b =>
                {
                    ...
                    b.HasIndex("TenantId", "PhoneNumber")
                        .HasDatabaseName("IX_Suppressions_Tenant_Phone")
                        .HasFilter("[Type] = 1");
            ...
            modelBuilder.Entity("Email.Server.Models.Tenants", b =>
                {
                    ...
                    b.Property<DateTime?>("ReputationWarningEmailSentAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Email.Server.Models.UsagePeriods", b =>
                {
                    ...
                    b.Property<long>("OverageSms")
                        .HasColumnType("bigint");

                    b.Property<long>("OverageSmsReportedToStripe")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Email.Server.Models.SmsEvents", b =>
                {
                    b.HasOne("Email.Server.Models.SmsMessages", "SmsMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Email.Server.Models.SmsMessages", b =>
                {
                    b.HasOne("Email.Server.Models.SmsPhoneNumbers", "PhoneNumber")
                        .WithMany()
                        .HasForeignKey("PhoneNumberId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Email.Server.Models.SmsTemplates", "Template")
                        .WithMany()
